        ...
        {!result ? (
          <main className="relative flex min-h-[calc(100vh-4.5rem)] flex-col justify-center pb-20 pt-12 lg:pt-4">
            <div className="grid items-center gap-12 lg:grid-cols-[1.2fr_0.8fr]">
              ...
              <aside className="dbti-hero-card hidden min-h-[22rem] p-6 lg:block">
                <div className="flex items-start justify-between"><span className="text-[10px] font-medium uppercase tracking-[0.2em] text-muted-foreground">Scan protocol / 001</span><ArrowUpRight className="size-4 text-[var(--primary)]" aria-hidden="true" /></div>
                <div className="mt-20"><p className="text-3xl font-medium tracking-[-0.05em] text-foreground">Measure what<br /><span className="dbti-accent-text">can be verified.</span></p><p className="mt-4 max-w-xs text-sm leading-6 text-muted-foreground">First-party signals form the score. Public findings stay cited and separate.</p></div>
                <div className="mt-8 grid grid-cols-2 gap-3"><div className="dbti-mini-card p-3"><Activity className="size-4 text-[var(--primary)]" /><p className="mt-4 text-xs text-muted-foreground">10 weighted factors</p></div><div className="dbti-mini-card p-3"><ShieldCheck className="size-4 text-[var(--secondary)]" /><p className="mt-4 text-xs text-muted-foreground">Evidence ledger</p></div></div>
              </aside>
            </div>
